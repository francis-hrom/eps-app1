        ...
        <Row>
          <Col>
            ...
            <p>
              ...
              is provided target web site url and list of relevant items (text).
              Then the tool visits the website and return the most statistically
              relevant selector.
            </p>
            ...
            <ul>
              <li>
                ...
                partners website will be the company's product/service listed.
                To check manually 100+ partner websites is highly inefficient
            ...
            <p>
              ...
              (rankings) are already preloaded from the major e-commerce
              websites (targets).
            </p>
          </Col>
          <Col lg={6}>
